            ...
            <div className="form-row2">
              <div className="form-group">
                ...
                <div className="checkbox-group">
                  <label><input type="checkbox" /> Recogida en finca</label>
                  <label><input type="checkbox" /> Envío a domicilio</label>
                  <label><input type="checkbox" /> Puntos de distribución</label>
                </div>
              </div>
            </div>
          </div>
